<header class="app-topbar">
    <div class="page-container topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <button class="topnav-toggle-button px-2" style="color: #2d714e;"data-bs-toggle="collapse"
        ...
        <div class="d-flex align-items-center gap-3">
          <!-- Display Company Name & Owner Name -->
          <div class="d-none d-lg-flex flex-column text-end">
            <span class="fw-bold text-dark" style="font-size: 16px; color:#2d714e !important">XYZ Pvt Ltd</span>
            <span class="text-muted" style="font-size: 14px;">Owner: John Doe</span>
        </div>
        </div>
...
<div id="google_translate_element" style="display:none;"></div>
            ...
            <div class="topbar-item">
                <div class="dropdown">
                    <button class="topbar-link dropdown-toggle drop-arrow-none" style="color: #2d714e;"
                        data-bs-toggle="dropdown" data-bs-offset="0,25" type="button" data-bs-auto-close="outside"
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" style="color: #2d714e;"
                        data-bs-toggle="dropdown" data-bs-offset="0,25" type="button" aria-haspopup="false"
                        aria-expanded="false">
                        <img src="{{ asset('tenant/assets/images/users/avatar-3.jpg') }}" width="32"
