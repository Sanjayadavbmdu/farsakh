...
<div class="page-title-head d-flex align-items-center gap-2">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-bold mb-0">My Rentals</h4>
    </div>
...
<div class="page-container">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Rentals</h4>
                    ...
                    <table id="scroll-vertical-datatable"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Edinburgh</td>
                                <td class="text-muted">
                                    <a href="javascript: void(0);" class="link-reset btn btn-primary">Request Maintenance</a>
