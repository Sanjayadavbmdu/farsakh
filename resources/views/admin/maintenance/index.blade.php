...
@section('content')
    <div class="page-title-head d-flex align-items-center gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-bold mb-0">Maintenance Companies Management</h4>
        </div>
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0 fs-13">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                <li class="breadcrumb-item active">Maintenance Companies</li>
            </ol>
        </div>
    </div>
    ...
    <div class="page-container">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Maintenance Companies</h4>
                        ...
                        <!-- Maintenance Companies Table -->
                        <table id="maintenance-companies-datatable" class="table table-striped dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Company ID</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>MC-001</td>
                                    <td>FixIt Services</td>
                                    <td>fixit@example.com</td>
...
@section('script')
    <script>
        ...
        //     $("#maintenance-companies-datatable").DataTable({
        //         responsive: true,
        //         language: {
        //             paginate: {
